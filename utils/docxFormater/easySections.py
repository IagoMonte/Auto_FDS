...
def mkSec9(Document,physicalState,color,odor,meltingPoint,boilingPoint,flammability,explosiveLimit,
    ...
    addLine(Document, 'Estado físico:', physicalState, True,alignment='Start')
    addLine(Document, 'Cor:', color,alignment='Start')
    addLine(Document, 'Odor e limite de odor:', odor, True,alignment='Start')
    addLine(Document, 'Ponto de fusão/ponto de congelamento:', meltingPoint,alignment='Start')
    addLine(Document, 'Ponto de ebulição ou ponto de ebulição inicial e faixa de ebulição:', boilingPoint,True,alignment='Start')
    addLine(Document, 'Inflamabilidade (sólido; líquidos e gás):', flammability,alignment='Start')
    addLine(Document, 'Limite inferior/superior de inflamabilidade ou explosividade:', explosiveLimit,True,alignment='Start')
    addLine(Document, 'Ponto de fulgor:', flashPoint,alignment='Start')
    addLine(Document, 'Temperatura de autoignição:', autoIgnitionTemperature,True,alignment='Start')
    addLine(Document, 'Temperatura de decomposição:', decompositionTemperature,alignment='Start')
    addLine(Document, 'pH:', pH,True,alignment='Start')
    addLine(Document, 'Viscosidade cinemática:', kinematicViscosity,alignment='Start')
    addLine(Document, 'Solubilidade:', waterSolubility,True,alignment='Start')
    addLine(Document, 'Coeficiente de partição - noctanol/água:', partitionCoefficient,alignment='Start')
    addLine(Document, 'Pressão de vapor:', vaporPressure,True,alignment='Start')
    addLine(Document, 'Densidade relativa:', relativeDensity,alignment='Start')
    addLine(Document, 'Densidade de vapor relativa:', relativeVaporDensity,True,alignment='Start')
    addLine(Document, 'Características das partículas (sólidos):', particleCharacteristics,alignment='Start')
    addLine(Document, 'Outras informações:', OtherInfo,True,alignment='Start')
