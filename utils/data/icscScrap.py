...
def getUrlByCAS(CasNumber: str) -> str:
    res = rq.get(f'https://www.inchem.org/lucidworks-solr-api/?locale=en&echoParams=none&wt=json&json.nl=arrarr&fl=Title_s%2CShortSummary_t%2CURL_s&sort=score%20desc&start=0&rows=10&q={CasNumber}%20ICSC&facet.limit=-1').json()
